			...
			<div id="content" role="main">
				...
				<article id="post-<?php the_ID() ?>" <?php post_class() ?>>
					...
					<div class="entry-content">
						...
						<div id="flashcard-swipe" class="carousel slide hiragana-swipe" data-ride="carousel" data-interval="false">
  							<div class="carousel-inner" role="listbox">
						    	<?php $kana_generator->print_flashcards() ?>
						  	</div>
						...
						jQuery(document).ready(function() {  
							jQuery('#flashcard-swipe').on('slide.bs.carousel', function () {
						  		scrollToAnchor('primary');
							});
						   jQuery("#flashcard-swipe").swiperight(function() {  
						      jQuery("#flashcard-swipe").carousel('prev');  
						    });  
						   jQuery("#flashcard-swipe").swipeleft(function() {  
